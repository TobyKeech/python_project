...
## MVP
- You should be able to create a Cod Profile with a user, gamer tag, kills, deaths, rank, weapon. 
- You will also have a User with a first name, last name and age. 
- Finally you will also create a Weapon which will have a user, name, type, ammo and range.
