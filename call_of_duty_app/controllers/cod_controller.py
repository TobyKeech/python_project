...
def new_profile():
    platform = platform_repository.select_all()
    weapon = weapon_repository.select_all()
    return render_template("codprofiles/new.html", all_weapons = weapon, all_platforms = platform)
